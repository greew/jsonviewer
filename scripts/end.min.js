...
*/
(function(){function b(){this.body=document.body;if(!(-1<document.location.hash.indexOf("raw"))){var a=this.u();if(!1!==a&&(a=a.textContent,a=this.o(a)||this.s(a),!1!==a)){try{a.json=JSON.parse(a.json)}catch(d){return}this.D(a);this.H()}}}b.prototype.u=function(){if(1!=this.body.childNodes.length)return!1;var a=this.body.childNodes[0];return"pre"!=a.tagName.toLowerCase()?!1:a};b.prototype.o=function(a){var d=a.charAt(0);return"{"==d||"["==d?{json:a}:!1};b.prototype.s=function(a){return(a=a.match(/^([^\(]+)\((([{\[])(.*)([}\]]))\)(;)?$/))?
{json:a[2],j:a[1],I:a[6]?!0:!1}:!1};b.prototype.D=function(a){this.style=this.createElement("link");this.style.setAttribute("rel","stylesheet");this.style.setAttribute("type","text/css");this.style.setAttribute("media","all");this.style.setAttribute("href",safari.extension.baseURI+"styles/style.css");this.buttons=this.A();this.b=this.createElement("div","prettified","Loading...");this.c=this.body.firstChild;this.c.hidden=!0;var d=this.createElement("div","root",[this.style,this.buttons,this.b,this.c]);
this.body.appendChild(d);this.b.textContent="";this.append(this.b,this.functionName(a,this.value(a.json)))};b.prototype.functionName=function(a,d){var e=void 0!==a.j,c=this.createDocumentFragment();e&&this.append(c,this.createElement("div","type function",a.j+"("));this.append(c,d);e&&this.append(c,")");return c};b.prototype.value=function(a){var d=this.a(a);switch(d){case "object":return this.B(a);case "array":return this.w(a);case "null":case "number":case "string":case "boolean":return this.C(a,
